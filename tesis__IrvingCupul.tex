...
\setlength{\parindent}{5ex}   % Sangría de 5 espacios (aproximadamente 5ex)

% Configuración del espacio interlineal
\onehalfspacing               % 1.5 espacios entre líneas
...
\begin{document}
	...
	\newpage
	\input{6_objetivos.tex}
	\newpage
	\input{7_marcoTeorico.tex}
	\newpage
	\input{8_metodologia.tex}
	\newpage
	\input{9_resultados.tex}
	\newpage
